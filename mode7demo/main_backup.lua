...
function playdate.update()
	...
	field:drawSampled(0, 70, 200, 50,  -- x, y, width, height
				...
				print("c / fieldscale", c / fieldscale, "s / fieldscale", s / fieldscale, "-s / fieldscale",-s / fieldscale, "c / fieldscale", c / fieldscale, "x/fieldwidth", x/fieldwidth, "y/fieldheight", y/fieldheight)
